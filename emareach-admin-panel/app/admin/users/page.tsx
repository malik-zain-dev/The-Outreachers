              ...
              <div className="flex gap-1 ml-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-8 pr-3 py-2 border border-gray-300 rounded-md text-sm w-48 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    value={searchTerm}
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                {filteredUsers.map((user) => (
                  <tr
                    key={user.id}
                    className={`hover:bg-gray-50 transition-colors ${selectedIds.has(user.id) ? "bg-blue-50/50" : ""}`}
                  >
