            ...
            {accounts.map((a) => (
              <tr key={a.id} className="hover:bg-zinc-50">
                ...
                <td className="border-b px-2 py-2">
                  {a.provider}
                  {a.oauth_connected && (
                    <span className="ml-1 rounded bg-blue-100 px-1.5 py-0.5 text-[10px] text-blue-700">OAuth</span>
                  )}
                </td>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-zinc-500">
                    Use your Outlook mailbox address (e.g. ritikmakhija@outlook.com), not the sign-in email, if they differ.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <input
