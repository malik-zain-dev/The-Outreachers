...
const PROVIDER_COLORS: Record<string, string> = {
  ...
  outlook: "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-400",
  yahoo: "bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-400",
  icloud: "bg-sky-100 text-sky-700 dark:bg-sky-950 dark:text-sky-400",
  zoho: "bg-orange-100 text-orange-700 dark:bg-orange-950 dark:text-orange-400",
  protonmail: "bg-violet-100 text-violet-700 dark:bg-violet-950 dark:text-violet-400",
  fastmail: "bg-cyan-100 text-cyan-700 dark:bg-cyan-950 dark:text-cyan-400",
  ...
  mailru: "bg-blue-50 text-blue-900 dark:bg-blue-950 dark:text-blue-200",
  tutanota: "bg-green-100 text-green-800 dark:bg-green-950 dark:text-green-300",
  hey: "bg-indigo-100 text-indigo-800 dark:bg-indigo-950 dark:text-indigo-300",
};
...
const TX_COLOR: Record<string, string> = {
  ...
  spend: "text-blue-600 dark:text-blue-400",
  bonus: "text-purple-600 dark:text-purple-400",
  refund: "text-sky-600 dark:text-sky-400",
  withdraw: "text-violet-600 dark:text-violet-400",
};
