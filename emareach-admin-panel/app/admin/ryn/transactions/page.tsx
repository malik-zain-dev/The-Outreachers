...
const TX_BADGE: Record<string, string> = {
  ...
  spend: "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-400",
  bonus: "bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-400",
  refund: "bg-sky-100 text-sky-700 dark:bg-sky-950 dark:text-sky-400",
  withdraw: "bg-violet-100 text-violet-700 dark:bg-violet-950 dark:text-violet-400",
};
