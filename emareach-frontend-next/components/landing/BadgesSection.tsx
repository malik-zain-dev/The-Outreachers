      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="rounded-2xl border border-border/50 bg-muted/10 px-6 py-8 lg:px-12 flex flex-col gap-7">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-5 lg:gap-x-12">
            ...
            {/* Product Hunt */}
            <a
              href="https://www.producthunt.com/products/emareach-ai/reviews/new?utm_source=badge-product_review&utm_medium=badge&utm_souce=badge-emareach-ai"
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-80 hover:opacity-100 hover:scale-[1.04] transition-all duration-200 flex items-center"
            >
              ...
              <img
                ...
                alt="Emareach AI - Stop Landing in Spam. Start Getting Replies. | Product Hunt"
                width={250}
                height={54}
            ...
            {/* NextGen Tools */}
            <a
              href="https://www.nxgntools.com/tools/emareach-ai?utm_source=emareach-ai"
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-80 hover:opacity-100 hover:scale-[1.04] transition-all duration-200 flex items-center"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="https://www.nxgntools.com/api/embed/emareach-ai?type=FEATURED_ON&hideUpvotes=true"
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-10 gap-y-5">
            ...
            {/* SoftwareSuggest */}
            <a
              href="https://www.softwaresuggest.com/emareach-ai"
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-80 hover:opacity-100 hover:scale-[1.04] transition-all duration-200 flex items-center"
            >
            ...
            >
              <a
                href="https://sourceforge.net/software/product/EmaReach/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            >
              <a
                href="https://topbusinesssoftware.com/products/EmaReach/reviews/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-xs text-muted-foreground"
              >
