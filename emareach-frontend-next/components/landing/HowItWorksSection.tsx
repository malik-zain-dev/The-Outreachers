...
const steps = [
  {
    ...
    desc: "Connect your Gmail or SMTP account in minutes. Emareach handles inbox setup and best practices for you.",
    icon: Mail,
  ...
  },
  {
    ...
    desc: "Upload your lead list and Emareach personalizes each email with AI variations and dynamic fields — at any scale.",
    icon: Zap,
