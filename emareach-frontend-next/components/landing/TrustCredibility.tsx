...
const METRICS = [
  ...
  { value: "3×",     label: "More pipeline",      sub: "Avg. per Emareach customer",   gradient: "from-cyan-500 to-blue-500"    },
  { value: "5,000+", label: "Businesses growing", sub: "Using Emareach to drive sales", gradient: "from-violet-500 to-purple-500"},
];
...
const TESTIMONIALS = [
  {
    ...
    content: "We 10×'d our pipeline in 60 days. Emareach's AI campaigns write personalized emails for every lead — our sales team is closing more deals than ever.",
    avatar: "SJ",
    rating: 5,
  ...
  },
  {
    ...
    content: "We replaced our entire email marketing stack with Emareach. AI builds the campaigns, automation handles follow-ups, and conversions are up 3× — all from one tool.",
    avatar: "MC",
    rating: 5,
