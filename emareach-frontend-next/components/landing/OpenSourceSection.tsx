...
import { GITHUB_URL, SOCIAL_KAPTAN_URL } from "@/components/layout/Header";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            EmaReach ships <span className="text-foreground/90 font-semibold">every feature those {""}
        ...
        <div className="max-w-3xl mx-auto rounded-2xl border-2 border-emerald-500/25 bg-emerald-500/[0.05] p-6 flex items-start gap-4 mb-12">
          ...
          <div>
            ...
            <p className="text-[13.5px] text-muted-foreground leading-relaxed">
              Warm the prospect on social first, then send. Everything above, wired to earn recognition before
              touchpoint two — the actual lever behind inbox placement and replies, powered by{" "}
              <a
                href={SOCIAL_KAPTAN_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="font-semibold text-emerald-700 dark:text-emerald-300 underline underline-offset-2 hover:opacity-80"
              >
                Social Kaptan
              </a>
              .
