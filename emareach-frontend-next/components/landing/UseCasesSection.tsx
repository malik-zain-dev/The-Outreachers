    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-14">
          ...
          >
            AI email marketing
            <span className="block mt-0.5 bg-gradient-to-r from-primary via-violet-500 to-accent bg-clip-text text-transparent">
              built for your business
            </span>
          </h2>
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed font-medium">
            Whether you're a founder, sales team, agency, or consultant — Emareach gives you the AI tools to grow revenue through email.
          </p>
        </div>
              ...
              <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed font-medium">
                    <span className="font-semibold text-primary">Emareach: </span>
                    {u.solution}
                  </p>
                </div>
              </div>
