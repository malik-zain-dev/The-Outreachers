    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl relative z-10 text-center">
        ...
        <p className="text-lg font-medium mb-10 max-w-xl mx-auto" style={{ color: "rgba(255,255,255,0.55)" }}>
          Create AI-powered campaigns, personalize every email, automate follow-ups, and convert more leads into customers — all from one platform. Join 5,000+ businesses already growing with Emareach.
        </p>

        {/* CTAs */}
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
          <Link href="/book-demo" className="group">
            <button
        ...
        <div className="flex flex-wrap justify-center gap-x-7 gap-y-2 text-[13px] font-medium" style={{ color: "rgba(255,255,255,0.4)" }}>
          {["No credit card", "7-day trial", "Cancel anytime", "Full feature access"].map((t) => (
