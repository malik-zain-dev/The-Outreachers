    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          >
            See Emareach in action —
            <span className="block mt-0.5 bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">
              no signup needed.
            </span>
          </h2>
            ...
            <div className="relative aspect-[16/9] w-full bg-background min-h-[600px]">
              {showFrame ? (
                <iframe
                  ref={iframeRef}
                  src={DEMO_IFRAME_SRC}
                  title="Emareach Interactive Product Tour"
                      ...
                      <>
                        ...
                        <div className="space-y-2.5 max-w-lg">
                          <p className="text-2xl sm:text-3xl font-black tracking-tight text-foreground leading-tight">
                            See how Emareach warms up your inbox with real people
                          </p>
