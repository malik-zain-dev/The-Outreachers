    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-primary/20 bg-gradient-to-br from-primary/8 via-violet-500/5 to-transparent p-7 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={s.label} className="flex items-baseline gap-2">
                    <span className="text-2xl font-black bg-gradient-to-r from-cyan-500 to-violet-500 bg-clip-text text-transparent">{s.value}</span>
