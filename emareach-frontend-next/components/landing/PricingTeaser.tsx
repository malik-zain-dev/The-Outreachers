...
export function PricingTeaser() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full blur-3xl pointer-events-none bg-violet-500/6 dark:bg-violet-500/10" />
          ...
          <div className="grid lg:grid-cols-[1fr_1.1fr]">
            ...
            <div className="p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-border/50">
              ...
              >
                ...
                <span className="block mt-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-violet-500 bg-clip-text text-transparent">
                  No per-inbox surprises.
                </span>
              </h2>
              <p className="text-muted-foreground font-medium leading-relaxed mb-8 text-[15px]">
                Inboxes, domains, warm-up, AI, and reply management in one subscription. Start free — no credit card required.
              </p>
            ...
            {/* Right: CTA card */}
            <div className="p-8 lg:p-12 flex flex-col justify-center items-start lg:items-center text-left lg:text-center bg-gradient-to-br from-primary/5 via-transparent to-violet-500/5">
