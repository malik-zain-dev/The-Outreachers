  ...
  const renderNavItem = (item: NavItem) => {
    ...
    const itemCls = cn(
      ...
      isCollapsed
        ...
        : hasChildren
          ...
          : "h-8 px-2.5 w-full",
      isActive
        ? "bg-gradient-to-r from-blue-600 to-blue-500 shadow-[0_1px_8px_rgba(59,130,246,0.28)]"
        : "hover:bg-white/[0.06]"
    );
        ...
        {badgeCount != null && (
          <motion.span
            ...
            className={cn(
              ...
              isActive
                ? "bg-white text-blue-600 border-0"
    ...
    const dot =
      isCollapsed && badgeCount != null && (
        <span className="absolute top-1 right-1 w-1.5 h-1.5 bg-blue-400 rounded-full ring-[1.5px] ring-sidebar" />
      );
            ...
            <li key={sub.path}>
              <Link
                ...
                className={cn(
                  ...
                  isSubActive
                    ? "bg-blue-500/[0.08] font-medium text-blue-400"
                ...
                {SubIcon ? (
                  ...
                  <span
                    className={cn(
                      ...
                      isSubActive ? "bg-blue-400" : "bg-sidebar-foreground/20"
                    )}
                  />
                )}
                  ...
                  <DropdownMenuItem key={sub.path} asChild>
                    <Link
                      ...
                      className={cn(
                        ...
                        isLearnWarmup && !isSubActive && "bg-blue-500/10 text-blue-300 hover:bg-blue-500/15",
                        isSubActive
                      ...
                      {SubIcon ? (
                        ...
                        <span
                          className={cn(
                            ...
                            isSubActive ? "bg-blue-400" : "bg-current opacity-25"
                          )}
                        />
                      ) : (
                        <span className="h-1.5 w-1.5 flex-shrink-0 rounded-full bg-blue-300/80" />
                      )}
                      <span className="min-w-0 flex-1 truncate">{sub.title}</span>
                      {isLearnWarmup && !isSubActive && (
                        <span className="ml-auto shrink-0 rounded-full border border-blue-300/25 bg-blue-500/15 px-1.5 py-0 text-[9px] font-semibold uppercase tracking-wide text-blue-200">
                          Guide
                        </span>
                      )}
                      {sub.premiumLabel && (
    ...
    <>
      ...
      >
        ...
        <div className="relative h-14 flex items-center px-3 border-b border-sidebar-border flex-shrink-0">
          ...
          >
            {isCollapsed ? (
              <div className="flex-shrink-0 rounded-[9px] bg-white flex items-center justify-center overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.2)] w-8 h-8">
                <Image
