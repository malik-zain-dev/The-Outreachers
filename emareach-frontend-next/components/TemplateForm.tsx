      ...
      >
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              For campaigns, <strong className="text-foreground">EmaReach unsubscribe</strong> uses the same tracking
              ...
              <div className="flex items-start gap-3 rounded-lg border border-border bg-muted/30 p-3">
                ...
                <div className="space-y-1">
                  <Label htmlFor="unsub-tracking" className="font-medium cursor-pointer">
                    EmaReach unsubscribe (recommended)
                  </Label>
                  <p className="text-xs text-muted-foreground">
              ...
              <div className="flex items-start gap-3 rounded-lg border border-border p-3">
                ...
                <div className="space-y-1 w-full">
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    Your own page (include &quot;unsubscribe&quot; in the path so clicks opt contacts out in EmaReach), or
                    a contact page.
                  </p>
                  <Input
                    id="unsubscribe-url"
