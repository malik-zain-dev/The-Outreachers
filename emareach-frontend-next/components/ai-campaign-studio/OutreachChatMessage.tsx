          ...
          <div
            className={cn(
              ...
              isUser
                ...
                : "text-foreground dark:prose-invert prose-p:text-foreground prose-li:text-foreground prose-headings:text-foreground prose-strong:text-foreground [&_a]:text-blue-600 [&_a]:underline hover:[&_a]:text-blue-700 dark:[&_a]:text-blue-400 dark:hover:[&_a]:text-blue-300"
            )}
          >
            <ReactMarkdown
