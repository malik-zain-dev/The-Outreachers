...
const DEFAULT_PRIMARY = { href: "/book-demo", label: "Book a demo" };
const DEFAULT_SECONDARY = { href: "/signup", label: "Try for Free" };
      ...
      <Link
        ...
        className={cn(
          ...
          isOnDark
            ...
            : "gradient-primary text-primary-foreground shadow-lg shadow-primary/25 hover:brightness-105",
          sizes.primary
        )}
      >
        {primary.label}
