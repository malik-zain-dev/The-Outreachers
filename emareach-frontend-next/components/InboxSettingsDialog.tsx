...
export function InboxSettingsDialog({ inbox, open, onOpenChange, onSuccess }: InboxSettingsDialogProps) {
  ...
  const [smtpProvider, setSmtpProvider] = useState<"custom" | "emareach">(
    (inbox.smtp_provider === "sendgrid" || inbox.smtp_provider === "emareach" ? "emareach" : (inbox.smtp_provider as "custom" | "emareach") || "custom")
  );
  ...
  useEffect(() => {
    ...
    setSmtpProvider(inbox.smtp_provider === "sendgrid" || inbox.smtp_provider === "emareach" ? "emareach" : (inbox.smtp_provider as "custom" | "emareach") || "custom");
                ...
                <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20 flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      ...
                      the email to match your SMTP username, or use EmaReach Provider for domain-level sending.
                    </p>
                  </div>
                </div>
              )}
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  {smtpProvider === "emareach" && (
                    <p className="text-xs text-muted-foreground">
                      Uses EmaReach&apos;s SendGrid configuration; no SMTP credentials are required here.
                    </p>
                  )}
                </div>
