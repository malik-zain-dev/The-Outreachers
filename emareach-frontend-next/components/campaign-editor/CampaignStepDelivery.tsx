      ...
      <Card className="overflow-hidden">
        ...
        <CardContent className="space-y-8 pt-6">
          {(campaignData.senderType === "gmail" || campaignData.senderType === "smtp") && (
            <div className="relative overflow-hidden rounded-lg border border-blue-200/80 bg-gradient-to-br from-blue-50/90 to-slate-50/50 p-4 dark:border-blue-900/40 dark:from-blue-950/30 dark:to-background/80">
              <div className="absolute left-0 top-0 h-full w-1 rounded-l-lg bg-gradient-to-b from-blue-500 to-blue-600" />
