...
function CustomNode({ data, selected }: { data: any; selected: boolean }) {
  ...
  if (runStatus === 'completed') {
    ...
    ringColor = '#2563eb';
    ringWidth = '2px';
    statusDot = <span className="absolute -top-1 -right-1 h-3 w-3 animate-pulse rounded-full bg-blue-500 border-2 border-white shadow-sm" />;
  ...
  return (
    <div className="relative">
      ...
      <Handle
        ...
        className="!h-5 !w-5 !bg-white !border-2 !border-slate-300 !rounded-full hover:!border-blue-500 hover:!bg-blue-50"
        style={{
          top: -12,
