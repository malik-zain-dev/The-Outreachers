      ...
      <div className="max-w-6xl mx-auto px-6 py-10 space-y-8">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <Button
            ...
            className="shrink-0 h-9 gap-1.5 bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm text-sm font-medium"
          >
                  ...
                  <td colSpan={6} className="px-5 py-16 text-center">
                    <div className="mx-auto flex flex-col items-center gap-3">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => setShowCreateForm(true)}
                        className="mt-1 h-8 text-xs bg-indigo-600 hover:bg-indigo-700 text-white"
                      >
                        New workflow
                      </Button>
                    </div>
                  ...
                  <td className="px-5 py-3.5 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="inline-flex items-center rounded-md px-2.5 py-1 text-[11px] font-medium text-slate-600 border border-slate-200 hover:border-indigo-300 hover:text-indigo-600 transition-colors bg-white "
                      >
                        Edit details
                      </button>
                      <Link
        ...
        <DialogContent className="sm:max-w-[480px] p-0 gap-0 overflow-hidden rounded-2xl border-slate-200 shadow-xl">
          ...
          <div className="px-6 py-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <select
                  id="workflow-scope"
                  className="flex h-9 w-full rounded-md border border-slate-200 bg-white px-3 py-1 text-sm text-slate-800 shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                  value={newScope}
          ...
          <div className="px-6 py-4 border-t border-slate-100 bg-slate-50 flex items-center justify-end gap-2">
            ...
            <Button
              ...
              className="h-9 text-sm bg-indigo-600 hover:bg-indigo-700 text-white gap-1.5"
            >
