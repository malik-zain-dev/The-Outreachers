    ...
    <div className="flex h-[calc(100vh-4rem)] flex-col bg-[#f8f9fb] font-sans" style={{ fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif" }}>
        ...
        <div className="flex items-center gap-2">
          ...
          {draft.status !== 'active' ? (
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-blue-600 px-4 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:opacity-60 active:scale-[0.98]"
            >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="relative flex-1 overflow-hidden">
            ...
            >
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <input
                    className="h-8 w-full rounded-lg border border-slate-200 bg-slate-50 px-3 text-xs font-medium text-slate-700 outline-none transition focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-100"
          ...
          {activeRun && (
            <div className="absolute left-4 top-4 z-10 flex items-center gap-2 rounded-xl border border-blue-100 bg-white/90 px-3 py-2 text-xs shadow-sm backdrop-blur">
              <span
              ...
              />
              <span className="font-medium text-blue-700">Run</span>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="space-y-1">
              ...
              <select
                className="h-9 w-full rounded-md border border-slate-200 bg-white px-3 text-xs text-slate-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div className="mt-4 flex justify-end gap-2">
            ...
            <button
              type="button"
              className="rounded-lg bg-blue-600 px-4 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
            ...
            <div className="space-y-3">
              <div>
                ...
                <FieldInput
                  ...
                  placeholder="https://your-app.com/api/emareach-workflow-webhook"
                />
              </div>
              <div>
...
{`{
  ...
  "trigger_context": { /* original workflow trigger context */ }
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  type="button"
                  className="rounded-lg bg-blue-600 px-3 py-1.5 text-[11px] font-semibold text-white shadow-sm transition hover:bg-blue-700 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
                  disabled={!cfg.url}
                  onClick={async () => {
    ...
    return (
      <div className="space-y-3">
        ...
        <label className="flex cursor-pointer items-center gap-2.5">
          <div className={`relative h-4.5 w-8 rounded-full transition ${cfg.all_lists_for_campaign ? 'bg-blue-500' : 'bg-slate-200'}`}>
            <input
              type="checkbox"
              className="sr-only"
