...
export default function GetStartedPage() {
  ...
  return (
    <AppPageShell
      title="Get Started"
      description="Follow this guide to set up EmaReach AI from signup to your first campaign. We recommend doing the steps in order."
    >
      ...
      <main className="flex-1 min-w-0 space-y-10 pb-16">
        ...
        <section id="before-you-start" className="scroll-mt-24">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-medium mb-1">What is EmaReach AI?</h4>
                <p className="text-sm text-muted-foreground">
                  EmaReach AI is an email outreach platform with AI-powered content, domain management, inbox warmup, campaign automation, and analytics. You connect domains and inboxes, import contacts, create templates, and run campaigns—all from one place.
                </p>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Create an account from the <Link href="/signup" className="text-primary hover:underline">signup</Link> page. After logging in, you can reset your password anytime via{" "}
        ...
        <section id="domains" className="scroll-mt-24">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                To send from your own domain (e.g. <code className="rounded bg-muted px-1.5 py-0.5 text-xs">you@yourcompany.com</code>), add the domain in EmaReach and complete DNS setup.
              </p>
              <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                ...
                <li>Click Verify in EmaReach. Once verified, the domain is ready to use.</li>
              </ol>
              <p className="text-sm text-muted-foreground">
              ...
              <HelpLinks slugs={["add-verify-sending-domain-emareach"]} className="mt-4" />
            </CardContent>
          </Card>
        </section>
        ...
        <section id="inbox-accounts" className="scroll-mt-24">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                <li><strong>EmaReach Provider</strong> — Use EmaReach&apos;s SendGrid sending; select your verified domain. No credentials required.</li>
        ...
        <section id="warmup" className="scroll-mt-24">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <HelpLinks
                slugs={[
                  "what-is-email-warmup-how-to-use-emareach",
        ...
        <section id="campaigns" className="scroll-mt-24">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <HelpLinks
                slugs={[
                  "create-first-campaign-emareach",
