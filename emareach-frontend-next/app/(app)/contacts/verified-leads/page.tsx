...
const WHATSAPP_NUMBER = "919535151254";
const WHATSAPP_LINK = `https://wa.me/${WHATSAPP_NUMBER}`;

export const metadata: Metadata = {
  title: "Buy List – Verified B2B Contact Lists | EmaReach",
  description:
...
const steps = [
  {
    ...
    title: "You provide",
    items: [
      "Link of the target site (e.g. https://www.aikaptan.com/)",
...
const testimonials = [
  {
    quote:
      "We went from a 22% bounce rate with our old list to under 4% with EmaReach. Our reply rate doubled in the first week.",
    name: "Sarah K.",
    role: "Head of Growth",
  ...
  {
    quote:
      "As an agency, we need fast turnaround and consistent quality. EmaReach delivers both. Our clients are seeing 3x better open rates.",
    name: "Marcus T.",
    role: "Founder",
      ...
      <section className="relative py-12 lg:py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl relative z-10">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-[2.75rem] font-bold tracking-[-0.02em] mb-5 leading-[1.15]">
            ...
            <span className="mt-2 block bg-gradient-to-r from-primary via-violet-500 to-accent bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-11">
            ...
            >
              <Button
                size="lg"
                className="gradient-primary min-h-[52px] px-7 font-bold rounded-xl shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all w-full sm:w-auto text-base"
              >
      ...
      <section className="py-10 lg:py-14 border-t border-border bg-muted/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-2">
              EmaReach vs. typical list providers
            </h2>
            <p className="text-muted-foreground max-w-xl">
          ...
          <div className="rounded-xl border-2 border-border overflow-hidden">
            <div className="grid grid-cols-3 bg-muted/50 border-b border-border text-sm font-semibold">
              ...
              <div className="p-4 text-primary">EmaReach</div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              >
                <Button
                  size="lg"
                  className="gradient-primary min-h-[48px] px-6 font-bold rounded-xl shadow-lg shadow-primary/25"
                >
                  Get a custom quote
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            >
              <Button
                size="lg"
                className="gradient-primary min-h-[52px] px-8 font-bold rounded-xl shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all w-full sm:w-auto text-base"
              >
                Contact on WhatsApp
                <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
