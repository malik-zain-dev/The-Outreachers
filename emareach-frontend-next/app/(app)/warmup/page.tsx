          ...
          >
            <div className="flex items-start gap-3 rounded-lg border border-primary/40 bg-primary/5 p-3 cursor-pointer hover:bg-primary/10" onClick={() => setSelectedMode("network")}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div
                  className="mt-3 rounded-lg border border-sky-500/25 bg-sky-500/5 p-3"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      >
                        ...
                        <Badge
                          variant="outline"
                          className="text-xs text-sky-700 border-sky-500/30 dark:text-sky-300 font-normal"
                        >
                          Credits based
                        </Badge>
                      </Label>
                      ...
                      {useSharedPoolAddon ? (
                        sharedPoolCredits > 0 && sharedPoolAvailableContacts > 0 ? (
                          <p className="text-sm text-sky-700 dark:text-sky-300 mt-1.5">
