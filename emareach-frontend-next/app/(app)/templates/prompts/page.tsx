...
The JSON must match this shape (default template body type for EmaReach is **"${defaultBodyTypeJson}"**):
...
- Optional root \`body_type\`: \`"plain"\`, \`"html"\`, or \`"rich"\`. Sets the default for every variation when imported into EmaReach. If omitted, importers use **"${defaultBodyTypeJson}"** from this prompt.
