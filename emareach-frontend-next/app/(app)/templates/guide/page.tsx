...
const tagColors: Record<string, string> = {
  ...
  violet: "bg-purple-500 text-white border-transparent hover:bg-purple-600",
      ...
      <section className="relative overflow-hidden rounded-2xl border bg-card mb-8">
        ...
        <div className="relative px-6 py-8 sm:px-8 sm:py-10">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight max-w-2xl">
            ...
            <span className="text-blue-600 dark:text-blue-400 font-semibold">Primary</span>, not Promotions or Spam
          </h1>
