            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                ...
                <strong className="text-foreground">
                  replies to emails that were sent through EmaReach
                </strong>{" "}
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <p>
                ...
                threads that are unrelated to emails sent via EmaReach. We only
            ...
            <CardContent className="space-y-3 text-muted-foreground">
              <ol className="list-decimal list-inside space-y-3 pl-1">
                <li>
                  ...
                  for new messages only in threads where EmaReach sent an email.
                </li>
                <li>
                  <strong className="text-foreground">
                ...
                <li>
                  ...
                  and show the reply in your EmaReach Inbox. The reply content is
