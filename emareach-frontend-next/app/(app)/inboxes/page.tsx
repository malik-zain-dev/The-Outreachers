...
function getInboxStatus(status: string) {
  switch (status) {
    ...
    case "warming":
      return (
        <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 dark:bg-blue-950/40 px-2.5 py-1 text-xs font-medium text-blue-700 dark:text-blue-300 ring-1 ring-inset ring-blue-600/20">
    ...
    <span
      className={cn(
        ...
        isGmail
          ...
          : "bg-sky-50 dark:bg-sky-950/40 text-sky-700 dark:text-sky-300 ring-sky-500/30"
      )}
    >
      {t}
    </span>
