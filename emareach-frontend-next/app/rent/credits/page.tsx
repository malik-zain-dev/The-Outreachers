    ...
    <div className="rounded-2xl border bg-card overflow-hidden">
      ...
      <div className="grid grid-cols-3 divide-x">
        ...
        <div className="px-4 py-4">
          ...
          <p className="text-base font-bold text-blue-600 dark:text-blue-400 tabular-nums flex items-center gap-1 mt-0.5">
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 hover:bg-muted/30 transition-colors">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-muted-foreground flex items-center gap-1.5 mt-0.5">
          ...
          <span className={cn(
            ...
            isWithdraw ? "bg-violet-100 text-violet-800 dark:bg-violet-950 dark:text-violet-400" :
            ...
            isRefund ? "bg-sky-100 text-sky-700 dark:bg-sky-950 dark:text-sky-400" :
            isEarn ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400" :
            isBonus ? "bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-400" :
      ...
      <span className={cn(
        ...
        isWithdraw ? "text-violet-600 dark:text-violet-400" :
        isHeld ? "text-amber-600 dark:text-amber-400" :
        isExpired ? "text-zinc-400" :
        isRefund ? "text-sky-600 dark:text-sky-400" :
