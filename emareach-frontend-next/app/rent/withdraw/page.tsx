...
const WITHDRAW_STATUS_BADGE: Record<string, string> = {
  ...
  processing: "bg-blue-100 text-blue-800 dark:bg-blue-950/50 dark:text-blue-400",
...
function WithdrawRequestRow({ w }: { w: RYNWithdrawRecord }) {
  return (
    <div className="flex items-center gap-3 px-4 py-3">
      <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 bg-violet-100 text-violet-700 dark:bg-violet-950 dark:text-violet-400">
