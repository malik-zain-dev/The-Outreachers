...
const defaultTitle = "Best AI Email Marketing Tool to 10× Your Sales | Emareach";
const defaultDescription =
  "Boost your email marketing with Emareach. Create AI-powered campaigns, personalize emails, automate follow-ups, improve deliverability, and convert more leads into customers.";
...
export const metadata: Metadata = {
  ...
  title: {
    ...
    template: "%s | EmaReach AI",
  },
  description: defaultDescription,
  keywords: defaultKeywords,
  authors: [{ name: "EmaReach AI", url: SITE_URL }],
  creator: "EmaReach AI",
  publisher: "EmaReach AI",
  robots: {
    index: true,
    follow: true,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Best AI Email Marketing Tool to 10× Your Sales | Emareach",
      },
    ],
  },
  twitter: {
