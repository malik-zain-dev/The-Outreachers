...
export const SITE_NAME = "EmaReach";
export const SITE_NAME_FULL = "EmaReach AI";
...
export function getOrganizationJsonLd() {
  return {
    ...
    "@id": ORG_ID,
    name: SITE_NAME,
    alternateName: [SITE_NAME_FULL, "EmaReach cold email"],
    url: SITE_URL,
    logo: {
      "@type": "ImageObject",
      url: LOGO_URL,
...
export function getHomeWebPageJsonLd() {
  return {
    ...
    "@id": `${SITE_URL}/#webpage`,
    url: SITE_URL,
    name: "Best AI Email Marketing Tool to 10× Your Sales | Emareach",
    description: BRAND_SUMMARY,
...
export function getResourceArticleJsonLd(opts: {
  title: string;
  description: string;
  slug: string;
  publishedAt: string;
  ...
  const url = `${SITE_URL}/resources/${opts.slug}`;
  return {
    "@context": "https://schema.org",
    "@type": "Article",
    "@id": `${url}#article`,
