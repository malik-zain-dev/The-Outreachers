...
export const PRODUCT_TOUR_STORAGE_KEY = "emareach_tour_completed";
...
export const productTourSteps: DriveStep[] = [
  {
    popover: {
      title: "Welcome",
      description:
        "Welcome to EmaReach AI. This short tour will show you the dashboard and main features so you can get started quickly.",
      side: "bottom",
      align: "center",
    },
  },
