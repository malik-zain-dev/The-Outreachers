...
variable "domain_name" {
  description = "Custom domain for the API (e.g. api.emareach.com). Used for app_url output. Point CNAME to the ALB DNS name (terraform output alb_dns_name)."
  type        = string
  default     = ""
}
