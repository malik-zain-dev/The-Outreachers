...
def test_detects_placeholder_name_emails():
    assert looks_like_placeholder_name_email("firstname@idigitalise.net") is True
    assert looks_like_placeholder_name_email("lastname@idigitalise.net") is True
    assert looks_like_placeholder_name_email("firstname.lastname@idigitalise.net") is True


def test_allows_real_name_patterns():
    assert looks_like_placeholder_name_email("ritik.makhija@idigitalise.net") is False
