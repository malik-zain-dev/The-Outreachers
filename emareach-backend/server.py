...
async def root():
    ...
    return RedirectResponse(url="https://www.emareach.com/", status_code=307)


# CORS: always allow production frontends; extend from CORS_ORIGINS or default to localhost
_cors_origins = [
    "https://www.emareach.com",
    "https://admin-emareach.com",
    "https://api.emareach.com",
]
