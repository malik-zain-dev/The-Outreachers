"""Send in-app notifications (campaign, reply, health, weekly, product) to the user's registered email via SendGrid (notification@emareach.com) or SMTP, respecting Notification Preferences."""
import logging
