...
def _header_html() -> str:
    return (
        ...
        "letter-spacing:-0.5px;font-family:Arial,sans-serif;'>EmaReach</span>"
        "</td></tr></table>"
    )
...
def _footer_html() -> str:
    return (
        ...
        "<p style='margin:0 0 4px;'>EmaReach &middot; Cold outreach, done right</p>"
        "<p style='margin:0;'>"
...
def lifecycle_templates(base_dashboard_url: str, book_demo_url: str) -> Dict[str, Dict[str, str]]:
    ...
    return {
        ...
        "email_1": {
            ...
            "plain": (
                "Hi {first_name},\n\n"
                "Welcome to EmaReach. You're 3 steps from sending your first cold campaign.\n\n"
            ...
            "html": _wrap_html(
                ...
                "<p style='margin:0 0 20px;color:#374151;'>Welcome to EmaReach. "
        ...
        "email_2": {
            ...
            "html": _wrap_html(
                ...
                "<p style='margin:0 0 20px;color:#374151;'>It takes about 5 minutes: add a couple of DNS records and EmaReach handles the rest.</p>"
                + _cta_button(domain_url, "Connect my domain")
                + _book_demo_block_html(book_demo_url)
            ),
        },
        ...
        "email_6": {
            ...
            "plain": (
                ...
                "Don't let the trial expire without seeing what EmaReach can do.\n\n"
            ...
            "html": _wrap_html(
                ...
                "<p style='margin:0 0 20px;color:#374151;'>"
                "Don't let the trial expire without seeing what EmaReach can do.</p>"
        ...
        "email_7": {
            ...
            "plain": (
                "Hi {first_name},\n\n"
                "Your EmaReach trial ends in 24 hours.\n\n"
        ...
        "email_10": {
            ...
            "plain": (
                "Hi {first_name},\n\n"
                "Welcome to EmaReach Pro. Your payment went through.\n\n"
            ...
            "html": _wrap_html(
                ...
                "font-size:13px;font-weight:600;padding:4px 10px;border-radius:20px;'>"
                "&#11088; Welcome to EmaReach Pro</span></p>"
                "<p style='margin:0 0 20px;color:#374151;'>"
        ...
        "email_12": {
            ...
            "plain": (
                "Hi {first_name},\n\n"
                "You're one week into EmaReach Pro.\n\n"
            ...
            "html": _wrap_html(
                "<p style='margin:0 0 6px;'>Hi {first_name},</p>"
                "<p style='margin:0 0 20px;color:#374151;'>"
                "You're one week into EmaReach Pro. Here's how you're tracking:</p>"
        ...
        "email_13": {
            ...
            "plain": (
                "Hi {first_name},\n\n"
                "You haven't logged into EmaReach in a while — just checking in.\n\n"
        ...
        # ------------------------------------------------------------------
        "renewal_email_1": {
            "subject": "Your EmaReach subscription ends in 3 days",
            "plain": (
                "Hi {first_name},\n\n"
                "Just a quick reminder that your EmaReach subscription will end in 3 days.\n\n"
            ...
            "html": _wrap_html(
                ...
                "</div>"
                "<p style='margin:0 0 16px;color:#374151;'>"
                "Just a quick reminder that your EmaReach subscription will end in 3 days.</p>"
                "<p style='margin:0 0 20px;color:#374151;'>"
        ...
        # ------------------------------------------------------------------
        "renewal_email_2": {
            "subject": "Your EmaReach subscription ends tomorrow",
            "plain": (
                "Hi {first_name},\n\n"
                "Your EmaReach subscription is set to expire tomorrow.\n\n"
            ...
            "html": _wrap_html(
                ...
                "</div>"
                "<p style='margin:0 0 16px;color:#374151;'>"
                "Your EmaReach subscription is set to expire tomorrow.</p>"
                "<p style='margin:0 0 20px;color:#374151;'>"
        ...
        # ------------------------------------------------------------------
        "renewal_email_3": {
            "subject": "Your EmaReach subscription has expired",
            "plain": (
                "Hi {first_name},\n\n"
                "Your EmaReach subscription has expired.\n\n"
            ...
            "html": _wrap_html(
                ...
                "</div>"
                "<p style='margin:0 0 16px;color:#374151;'>"
                "Your EmaReach subscription has expired.</p>"
                "<p style='margin:0 0 20px;color:#374151;'>"
        ...
        # ------------------------------------------------------------------
        "renewal_email_4": {
            "subject": "Still want to continue with EmaReach?",
            "plain": (
                "Hi {first_name},\n\n"
                "Just following up in case you still wanted to continue with EmaReach.\n\n"
            ...
            "html": _wrap_html(
                "<p style='margin:0 0 6px;'>Hi {first_name},</p>"
                "<p style='margin:0 0 16px;color:#374151;'>"
                "Just following up in case you still wanted to continue with EmaReach.</p>"
                "<p style='margin:0 0 20px;color:#374151;'>"
        ...
        "renewal_email_5": {
            ...
            "plain": (
                "Hi {first_name},\n\n"
                "We noticed you haven't renewed your EmaReach subscription, and we just wanted to check in.\n\n"
            ...
            "html": _wrap_html(
                "<p style='margin:0 0 6px;'>Hi {first_name},</p>"
                "<p style='margin:0 0 16px;color:#374151;'>"
                "We noticed you haven't renewed your EmaReach subscription, and we just wanted to check in.</p>"
                "<p style='margin:0 0 16px;color:#374151;'>"
        ...
        # ------------------------------------------------------------------
        "renewal_email_6": {
            "subject": "Thank you for renewing your EmaReach subscription",
            "plain": (
                "Hi {first_name},\n\n"
                "Thank you for renewing your EmaReach subscription.\n\n"
            ...
            "html": _wrap_html(
                ...
                "<p style='margin:0 0 16px;color:#374151;'>"
                "Thank you for renewing your EmaReach subscription.</p>"
                "<p style='margin:0 0 16px;color:#374151;'>"
