...
OUT_OF_SCOPE_MESSAGE = (
    "I’m set up to answer questions about EmaReach’s help articles. "
    "This message looks like it might be about something else, so I don’t want to guess "
    "and give you a wrong answer. If you have a question about EmaReach, feel free to ask."
)

SYSTEM_PROMPT = """You are the EmaReach support assistant.

Your job:
- Answer the user's question using ONLY the information from the EmaReach help articles provided below.
    ...
    if is_groq_available():
        try:
            ...
            user_content = (
                ...
                f"{query}\n\n"
                "Information from the EmaReach help center (most relevant items first). "
